...
def main_window():
    ...
    label2.place(x=100,y=130,height=50,width=300)

    enter2=Entry(win,font=("Time New Roman",20))
    enter2.place(x=50,y=190,height=50,width=400)


    button=Button(win,text="Done",font=("Time New Roman ",25,"bold"),bg="black",fg="white",command=correct_spelling)
